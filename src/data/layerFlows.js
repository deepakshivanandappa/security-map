...
export const LAYER_FLOWS = {
  network: [
    ...
    { id: "sase",      label: "SASE / SSE",      sub: "outbound · employees → internet", terms: ["SASE", "SSE", "SWG", "CASB", "FWaaS", "SD-WAN"] },
    { id: "ztna_net",  label: "ZTNA",            sub: "inbound · private access",        terms: ["ZTNA"] },
